...
from codegraph.export.viz.api import export_html, export_html_from_json, main
...
def __getattr__(name: str):
    ...
    if name == "layer_graph_to_cytoscape":
        from codegraph.export.viz.transform import layer_graph_to_cytoscape as _fn
        return _fn
    if name == "KIND_COLORS":
        from codegraph.export.viz.styles import KIND_COLORS as _kc
        return _kc
    if name == "EDGE_COLORS":
        from codegraph.export.viz.styles import EDGE_COLORS as _ec
        return _ec
    if name == "cy_stylesheet":
        from codegraph.export.viz.styles import cy_stylesheet as _cs
        return _cs
