...
class TestMarkdownIntegration:
    ...
    def test_export_produces_valid_markdown(self):
        ...
        # Save the .md file
        out_path = Path(__file__).resolve().parent / "data" / "design_graph.md"
    ...
    def test_roundtrip_reexport(self):
        ...
        out_path = Path(__file__).resolve().parent / "data" / "design_graph_roundtrip.md"
    ...
    def test_import_serializes_to_json(self):
        ...
        out_path = Path(__file__).resolve().parent / "data" / "design_graph_md.json"
        out_path.write_text(
