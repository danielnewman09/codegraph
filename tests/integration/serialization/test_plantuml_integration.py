...
class TestPlantUMLIntegration:
    ...
    def test_export_produces_valid_plantuml(self):
        ...
        # Save the .puml file
        out_path = Path(__file__).resolve().parent / "data" / "plantuml_integration.puml"
    ...
    def test_compile_to_png(self):
        ...
        puml = export_plantuml(self.graph)
        out_path = Path(__file__).resolve().parent / "data" / "plantuml_integration.png"
    ...
    def test_roundtrip_compile_to_png(self):
        ...
        out_path = Path(__file__).resolve().parent / "data" / "plantuml_roundtrip.png"
