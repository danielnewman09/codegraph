...
FIXTURE_PATHS = [
    pytest.param(Path(__file__).resolve().parent / "data" / "design_graph.json", id="design_graph"),
    pytest.param(Path(__file__).resolve().parent / "data" / "cpp-sqlite_export.json", id="cpp_sqlite"),
]
...
class TestHtmlScreenshot:
    ...
    def test_json_to_html_to_png(self, fixture_path: Path, tmp_path: Path):
        ...
        png_path = Path(__file__).resolve().parent / "data" / f"{fixture_stem}_screenshot.png"
...
class TestHtmlScreenshotSmall:
    ...
    def test_small_size_html_to_png(self, fixture_path: Path, tmp_path: Path):
        ...
        png_path = Path(__file__).resolve().parent / "data" / f"{fixture_stem}_small_screenshot.png"
        stats_text, _js_errors, _console = _render_and_assert(
